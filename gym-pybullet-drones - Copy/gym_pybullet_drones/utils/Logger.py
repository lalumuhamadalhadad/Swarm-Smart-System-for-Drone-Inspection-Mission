...
class Logger(object):
    ...
    def plot(self, pwm=False):
        ...
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('x (m)', fontsize=12, fontweight='bold')

        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 1, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('y (m)', fontsize=12, fontweight='bold')

        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 2, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('z (m)', fontsize=12, fontweight='bold')
        ...
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('ϕ (rad)', fontsize=12, fontweight='bold')
        row = 4
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 7, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('θ (rad)', fontsize=12, fontweight='bold')
        row = 5
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 8, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('ψ (rad)', fontsize=12, fontweight='bold')
        ...
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('vx (m/s)', fontsize=12, fontweight='bold')
        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 4, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('vy (m/s)', fontsize=12, fontweight='bold')
        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 5, :], label="drone_"+str(j))
        axs[row, col].set_xlabel('time', fontsize=12, fontweight='bold')
        axs[row, col].set_ylabel('vz (m/s)', fontsize=12, fontweight='bold')
